...
const translations = {
  th: {
    ...
    label_chart_pattern: 'ลักษณะกราฟ',
    box_chart_pattern: '📉 วิเคราะห์ลักษณะกราฟ',
    opt_strat_trend: 'เทรดตามเทรนด์',
    opt_strat_grid: 'วางออเดอร์เป็นชั้น ๆ',
    opt_strat_scalp: 'เก็งกำไรสั้น ๆ',
    opt_strat_break: 'เทรดตอนราคาทะลุแนวรับ–แนวต้าน',
    opt_strat_range: 'เทรดไซด์เวย์',
    opt_strat_reversal: 'แนวเด้ง',     
    opt_strat_conviction: 'ไม้รวย', 
    opt_strat_smart: 'ตามเจ้า',
    label_emotion: 'ระดับอารมณ์ (1-10)',
    label_mistake: 'ข้อผิดพลาดหลัก',
    opt_mis_no_mistake: 'ตามแผนปกติ',
    opt_mis_no_sl: 'ไม่ตั้ง SL',
    opt_mis_oversize: 'ออก Lot ใหญ่เกิน',
    opt_mis_overtrade: 'เทรดรัว ๆ',
    opt_mis_fomo: 'กลัวตกรถ',
    opt_mis_revenge: 'อยากเอาคืน',
    opt_mis_no_plan: 'ไม่มีแผน',
    label_plan: 'ทำตามแผนไหม',
    label_notes: 'บันทึกเพิ่มเติม',
    chart_dist_title: '📏 ระยะห่าง SL & TP เฉลี่ย',
    chart_dist_title_subtitle: 'ระยะห่าง SL & TP เฉลี่ย',
    chart_dist_subtitle: 'แยกตามกลยุทธ์',
    chart_dist_y_axis: 'ระยะ (จุด)',
    chart_dist_sl: 'ระยะยอมแพ้ (SL)',
    chart_dist_tp: 'ระยะหวังผล (TP)',
    unit_pts: 'จุด',
    chart_equity_title: 'การเติบโตของพอร์ต',
    ...
    opt_pat_uptrend: 'เทรนขึ้น',
    opt_pat_downtrend: 'เทรนลง',
    opt_pat_bottom: 'โซนล่าง',
    opt_pat_top: 'โซนบน',
    ...
    // Messages
    msg_auto_calc: 'ระบบคำนวณ P&L, P&L%, R:R และเวลาที่ถือให้อัตโนมัติ',
    btn_save: 'บันทึกเทรด',
    ...
    dash_tf_title: '📊 วิเคราะห์ Time Frame',
    chart_pnl_title: 'กำไรสุทธิ',
    chart_tf_label: 'แยกตาม Time Frame',
    chart_winrate_title: 'อัตราชนะ',
    chart_acc_label: '% ความแม่นยำ',
    chart_target_50: 'เป้าหมาย 50%',
    
    // Sections
    dash_table_title: '📝 ประวัติการเทรด',
    dash_chart_title: '⏰ ช่วงเวลาทำกำไร',
    box_dash_chart_title: 'ช่วงเวลาทำกำไร',
    ...
    stat_target_pf: 'เป้าหมาย: ≥1.5 (ดี), ≥2.0 (เยี่ยม)', 
    stat_target_rr: 'เป้าหมาย: ≥2:1 (เยี่ยม), ≥1.5:1 (ดี)', 
    stat_target_dd: 'เป้าหมาย: <15% (ดี), <25% (พอรับได้)', 
    stat_plan_note: 'ไม้ที่ทำตามแผน', 
    stat_no_mistake: 'ไม่มีข้อผิดพลาด 🎉', 
    stat_emotion_note: 'ขาดทุนเมื่ออารมณ์รุนแรง (≥7/10)', 
    stat_best_strat_note: 'ต้องมีขั้นต่ำ 3 ไม้ & Win Rate ≥50%',
    ...
    th_risk_dist: 'ระยะความเสี่ยง (SL)',
    th_reward_dist: 'ระยะหวังผล (TP)',
    th_rr: 'R:R',
    th_time: 'เวลาที่ถือ',
    th_strategy: 'กลยุทธ์',
    th_emo: 'อารมณ์',
    ...
    // Withdrawals Page
    withdraw_title: 'บันทึกการถอนเงิน',
    withdraw_subtitle: 'จัดการประวัติการถอนเงินและคำนวณภาษีเบื้องต้น',
    label_year: 'ปี:',
    option_all_time: 'ทั้งหมด',
    card_total_withdrawn: 'ยอดถอนสุทธิ',
    card_profit_only: 'เฉพาะส่วนกำไร',
    card_transactions: 'จำนวนรายการ',
    card_est_tax: 'ภาษีที่ต้องจ่ายโดยประมาณ',
    tax_warning_title: 'คำเตือนเรื่องการคำนวณภาษี',
    tax_warning_desc: 'ตัวเลขภาษีข้างต้นเป็นเพียงการ "ประมาณการเบื้องต้น" ตามอัตราก้าวหน้า (ภ.ง.ด. 90/91) โดยคำนวณจาก (รายได้อื่น + กำไรที่ถอน) หักลบค่าลดหย่อนพื้นฐานสมมติที่ 160,000 บาทเท่านั้น ยังไม่รวมค่าลดหย่อนส่วนตัวอื่นๆ (เช่น ประกัน, RMF, ดอกเบี้ยบ้าน) โปรดปรึกษาผู้เชี่ยวชาญบัญชีหรือสรรพากรเพื่อความถูกต้อง',
    form_title_add: '📝 บันทึกใหม่',
    form_title_edit: '✏️ แก้ไขรายการ',
    btn_cancel: 'ยกเลิก',
    label_withdraw_date: 'วันที่ถอน',
    label_amount_withdraw: 'จำนวนเงิน (THB)', 
    label_bank: 'เข้าธนาคาร',
    label_is_profit: 'นี่คือกำไร (ไม่ใช่ทุน)',
    label_is_profit_note: '*นำไปคำนวณภาษีเฉพาะส่วนนี้',
    ph_notes_withdraw: 'เช่น ถอนไปซื้อ iPad...',
    btn_save_withdraw: 'บันทึกรายการ',
    btn_update_withdraw: 'อัปเดตข้อมูล',
    tax_settings_title: '⚙️ รายได้ทางอื่นต่อปี',
    label_other_income: 'เช่น เงินเดือน/โบนัส',
    ph_other_income: 'เช่น 300000',
    table_title_history: '📜 ประวัติการถอน',
    ...
    type_profit: 'กำไร',
    type_capital: 'ทุน',
    msg_mobile_scroll: 'เลื่อนตารางไปทางซ้ายเพื่อดูข้อมูลเพิ่มเติม',
    msg_delete_success: 'ลบรายการสำเร็จ ✅',
    msg_delete_fail: 'ลบไม่สำเร็จ ❌',
    msg_delete_error: 'เกิดข้อผิดพลาดในการลบ ❌',
    msg_save_success: 'บันทึกการถอนเรียบร้อย ✅',
    msg_update_success: 'แก้ไขข้อมูลสำเร็จ ✅',
    msg_save_error: 'เกิดข้อผิดพลาด ❌',
    title_success: 'สำเร็จ',
    title_error: 'ข้อผิดพลาด',
    confirm_delete: 'ยืนยันที่จะลบรายการนี้?',
  },
  en: {
    // Navbar
    nav_welcome: 'Welcome,',
    ...
    opt_strat_trend: 'Trend Following',
    opt_strat_grid: 'Grid',
    opt_strat_scalp: 'Scalping',
    opt_strat_break: 'Breakout',
    opt_strat_range: 'Range Trading',
    opt_strat_reversal: 'Reversal',   
    opt_strat_conviction: 'High Conviction',
    opt_strat_smart: 'Smart Money',
    label_strategy: 'Strategy',
    label_chart_pattern: 'Chart Pattern',
    box_chart_pattern: '📉 Chart Pattern Analysis',

    // Chart Patterns
    opt_pat_unclear: 'Unclear',
    opt_pat_uptrend: 'Uptrend',
    opt_pat_downtrend: 'Downtrend',
    opt_pat_bottom: 'Bottom Zone',
    opt_pat_top: 'Top Zone',
    opt_pat_sideways: 'Side way',

    label_emotion: 'Emotion Level (1-10)',
    label_mistake: 'Main Mistake',
    opt_mis_no_mistake: 'No Mistake',
    opt_mis_no_sl: 'No SL',
    opt_mis_oversize: 'Oversize',
    opt_mis_overtrade: 'Overtrade',
    opt_mis_fomo: 'FOMO',
    opt_mis_revenge: 'Revenge Trading',
    opt_mis_no_plan: 'No Plan',
    label_plan: 'Followed Plan?',
    label_notes: 'Notes',
    chart_dist_title: '📏 Avg. SL & TP Distance',
    chart_dist_title_subtitle: 'Avg. SL & TP Distance',
    chart_dist_subtitle: 'By Strategy',
    chart_dist_y_axis: 'Distance (Points)',
    chart_dist_sl: 'Avg SL (Risk)',
    chart_dist_tp: 'Avg TP (Reward)',
    unit_pts: 'pts',
    chart_equity_title: 'Port Growth',
    ...
    dash_tf_title: '📊 Time Frame Analysis',
    chart_pnl_title: 'Total P&L',
    chart_tf_label: 'By Time Frame',
    chart_winrate_title: 'Win Rate',
    chart_acc_label: '% Accuracy',
    chart_target_50: 'Target 50%',

    // Sections
    dash_table_title: '📝 All Trades',
    dash_chart_title: '⏰ Trading Hours Chart',
    box_dash_chart_title: 'Trading Hours Chart',
    ...
    th_pnl: 'P&L',
    th_pnl_pct: 'P&L %',
    th_risk_dist: 'Risk Dist. (SL)',
    th_reward_dist: 'Reward Dist. (TP)',
    th_rr: 'R:R',
    th_time: 'Time',
    ...
    // Withdrawals Page
    withdraw_title: 'Withdrawals Log',
    withdraw_subtitle: 'Manage withdrawal history and estimate tax',
    label_year: 'Year:',
    option_all_time: 'All Time',
    card_total_withdrawn: 'Net Withdrawn',
    card_profit_only: 'Profit Only',
    card_transactions: 'Transactions',
    card_est_tax: 'Estimated Tax',
    tax_warning_title: 'Tax Calculation Disclaimer',
    tax_warning_desc: 'The tax figures above are "preliminary estimates" based on progressive rates (P.N.D. 90/91). Calculated from (Other Income + Withdrawn Profit) minus a hypothetical basic deduction of 160,000 THB. This does not include other personal deductions (e.g., insurance, RMF, mortgage interest). Please consult an accountant or the Revenue Department for accuracy.',
    form_title_add: '📝 New Entry',
    form_title_edit: '✏️ Edit Entry',
    btn_cancel: 'Cancel',
    label_withdraw_date: 'Date',
    label_amount_withdraw: 'Amount (THB)',
    label_bank: 'Bank',
    label_is_profit: 'This is Profit (Not Capital)',
    label_is_profit_note: '*Only this part is used for tax calc',
    ph_notes_withdraw: 'e.g. Withdrew for iPad...',
    btn_save_withdraw: 'Save Record',
    btn_update_withdraw: 'Update Record',
    tax_settings_title: '⚙️ Other Annual Income',
    label_other_income: 'e.g. Salary/Bonus',
    ph_other_income: 'e.g. 300000',
    table_title_history: '📜 Withdrawal History',
    ...
    msg_mobile_scroll: 'Scroll left to see more',
    ...
    msg_save_error: 'An error occurred ❌',
