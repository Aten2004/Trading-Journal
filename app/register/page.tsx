...
export default function RegisterPage() {
  ...
  // เพิ่ม State สำหรับสลับโหมดดูรหัสผ่านทั้ง 2 ช่อง
          ...
          <div className="relative">
            ...
            <div className="relative">
              <input
                ...
                className="w-full p-2.5 rounded-lg bg-gray-700 border border-gray-600 focus:border-green-500 focus:outline-none text-sm transition-colors pr-10"
                required
              />
              <button
                type="button"
